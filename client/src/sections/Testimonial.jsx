...
const Testimonial = () => {
  const feedback = [
    {
      desc: "ShareGo made my daily commute a breeze! The app is user-friendly, and I've most some wonderfuli people through carpooling. Thank you RideShare for providing such a fantastic service.",
